...
/*   Updated: 2022/02/07 08:39:21 by mmondell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    {
        ...
        try {
            ...
            std::cout << ORANGE << e.what() << BRED << " Array is empty." << END << std::endl;
        }
    }
...

    {
        ...
        try {
            ...
            std::cout << ORANGE << e.what() << BRED << " Invalid Index" << END << std::endl;
        }
    }
