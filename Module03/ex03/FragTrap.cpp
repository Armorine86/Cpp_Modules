...
/*   Updated: 2022/01/26 09:13:33 by mmondell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap() { 
	...
	std::cout << "FragTrap <" << name_ << "> It's time to phase you suckers out! [DEFAULT]" << std::endl;
}
...
FragTrap::FragTrap(const std::string& name) : ClapTrap(name) {
	...
	std::cout << "FragTrap <" << name_ << "> It's time to phase you suckers out! [OVERLOAD]" << std::endl;
}
...
FragTrap::FragTrap(const FragTrap& src) : ClapTrap(src) {
	...
	std::cout << "FragTrap <" << name_ << "> It's time to phase you suckers out! [COPY]" << std::endl;
}
...
void FragTrap::highFivesGuys() {
	...
	std::cout << "FragTrap <" << name_ << "> Secret handshake!" << std::endl;
}
//* ===============================================================================
