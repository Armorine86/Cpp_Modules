...
/*   Updated: 2022/01/27 08:45:50 by mmondell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (this->Hitpoints > 0)
        std::cout << "ScavTrap <" << this->name_ << "> is leaving the battlefield" << std::endl;
    else
...
{
    std::cout << "SkavTrap <" << this->name_ << "> attack <" << target << ">, causing <"
